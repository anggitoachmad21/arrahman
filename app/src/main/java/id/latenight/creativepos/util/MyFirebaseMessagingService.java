...
import id.latenight.creativepos.MenuActivity;
import id.latenight.creativepos.OrderDetailActivity;
    ...
    private void sendNotification(RemoteMessage remoteMessage) {
        ...
        if(!action.isEmpty()) {
            if (action.equals("order")) {
                ...
                intent.putExtra("order_id", remoteMessage.getData().get("sales_id"));
            }
        } else {
