...
public class SearchableListDialog extends DialogFragment implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    private String _strPositiveButtonText, _strNegativeButtonText;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strPositiveButton = _strPositiveButtonText == null ? getResources().getString(R.string.close) : _strPositiveButtonText;
        alertDialog.setPositiveButton(strPositiveButton, (dialog, which) -> {
            dialog.dismiss();
            Log.e("tutup", "TUTUP");
        });

        String strNegativeButtonText = _strNegativeButtonText == null ? "" : _strNegativeButtonText;
        alertDialog.setNegativeButton(strNegativeButtonText, _onClickListener);
